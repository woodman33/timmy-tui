...
function reviewComment(v: unknown): string { if (typeof v !== 'string' || v.length < 1 || v.length > 1200) fail('invalid_text', 'Invalid bounded text.'); return v; }
