...
export const initialShell = (): ShellState => ({ mode: 'NORMAL', tab: 'HOME', input: '', overlay: null, filter: '', selected: 0, pick: 0, handsOn: false, handsRow: 0, handsCol: 0, handsPrompt: false });
